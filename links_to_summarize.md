...
- https://docs.cloud.google.com/architecture/framework/perspectives/ai-ml/performance-optimization
- https://docs.cloud.google.com/architecture/framework/perspectives/ai-ml/cost-optimization

#### financial services industry
- https://docs.cloud.google.com/architecture/framework/perspectives/fsi/operational-excellence
- https://docs.cloud.google.com/architecture/framework/perspectives/fsi/security
- https://docs.cloud.google.com/architecture/framework/perspectives/fsi/reliability
- https://docs.cloud.google.com/architecture/framework/perspectives/fsi/performance-optimization
- https://docs.cloud.google.com/architecture/framework/perspectives/fsi/cost-optimization


## Deployment Archetypes

- https://docs.cloud.google.com/architecture/deployment-archetypes/zonal
- https://docs.cloud.google.com/architecture/deployment-archetypes/regional
- https://docs.cloud.google.com/architecture/deployment-archetypes/multiregional
- https://docs.cloud.google.com/architecture/deployment-archetypes/global
- https://docs.cloud.google.com/architecture/deployment-archetypes/hybrid
- https://docs.cloud.google.com/architecture/deployment-archetypes/multicloud
- https://docs.cloud.google.com/architecture/deployment-archetypes/comparison

### Reference architectures 
- https://docs.cloud.google.com/architecture/single-zone-deployment-compute-engine
- https://docs.cloud.google.com/architecture/regional-deployment-compute-engine
- https://docs.cloud.google.com/architecture/multiregional-vms
- https://docs.cloud.google.com/architecture/global-deployment-compute-engine-spanner

## Landing zone design
- https://docs.cloud.google.com/architecture/landing-zones
- https://docs.cloud.google.com/architecture/landing-zones/decide-how-to-onboard-identities
...
(back to landing zone design)
- https://docs.cloud.google.com/architecture/landing-zones/decide-security

## Entreprise Foundation BluePrint

### Architecture
- https://docs.cloud.google.com/architecture/blueprints/security-foundations/authentication-authorization
- https://docs.cloud.google.com/architecture/blueprints/security-foundations/organization-structure
- https://docs.cloud.google.com/architecture/blueprints/security-foundations/networking
- https://docs.cloud.google.com/architecture/blueprints/security-foundations/detective-controls
- https://docs.cloud.google.com/architecture/blueprints/security-foundations/preventative-controls
(back to Entreprise Foundation BluePrint)
...
### use cases 
- https://docs.cloud.google.com/architecture/agentic-ai-interactive-learning
- https://docs.cloud.google.com/architecture/agentic-ai-data-science
- https://docs.cloud.google.com/architecture/agenticai-orchestrate-access-disparate-systems

## Generative AI

### Gen Ai with RAG
- https://docs.cloud.google.com/architecture/private-connectivity-rag-capable-gen-ai
...
- https://docs.cloud.google.com/architecture/ai-ml/generative-ai-rag
...
- https://docs.cloud.google.com/architecture/partners/harness-cicd-pipeline-for-rag-app
...
### use cases 
- https://docs.cloud.google.com/architecture/use-generative-ai-utilization-management
- https://docs.cloud.google.com/architecture/ai-ml/generative-ai-knowledge-base
- https://docs.cloud.google.com/architecture/genai-marketing-campaigns
- https://docs.cloud.google.com/architecture/genai-product-recommendations
- https://docs.cloud.google.com/architecture/genai-podcasts-from-commentary
- https://docs.cloud.google.com/architecture/genai-customer-support
- https://docs.cloud.google.com/architecture/ai-ml/generative-ai-document-summarization
...
- https://docs.cloud.google.com/architecture/building-a-vision-analytics-solution
- https://docs.cloud.google.com/architecture/security/confidential-computing-analytics-ai
- https://docs.cloud.google.com/architecture/cross-silo-cross-device-federated-learning-google-cloud
- https://docs.cloud.google.com/architecture/implement-two-tower-retrieval-large-scale-candidate-generation
- https://docs.cloud.google.com/architecture/partners/model-development-data-labeling-labelbox-google-cloud
- https://docs.cloud.google.com/architecture/use-vertex-ai-pipelines-for-propensity-modeling
- https://docs.cloud.google.com/architecture/partners/c3-ai-architecture
